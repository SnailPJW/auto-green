...
- 修改 [ci.yml 文件的第 19、20 行](https://github.com/SnailPJW/auto-green/blob/master/.github/workflows/ci.yml#L19) 为自己的 GitHub 账号和昵称
- (可选) 你可以通过修改 [ci.yml 文件的第 8 行](https://github.com/SnailPJW/auto-green/blob/master/.github/workflows/ci.yml#L8)来调整频率
